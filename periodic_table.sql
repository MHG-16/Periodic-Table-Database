...
--
-- Name: elements unique_name_element; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_name_element UNIQUE (name);


--
-- Name: elements unique_symbol_element; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_symbol_element UNIQUE (symbol);
